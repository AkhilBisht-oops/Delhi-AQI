...
const Tips = () => {
  ...
  const tips = [
    ...
    },
    {
      ...
      description: 'Consult real-time temporal trends and shift intensive physical activities to periods with minimal vehicular density, typically pre-dawn or post-midnight.',
                    ...
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="flex gap-2">
                        <span className={`px-2 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider ${
                          tip.impact === 'Critical' ? 'bg-rose-500/10 text-rose-500' : 'bg-emerald-500/10 text-emerald-500'
                        }`}>
                          {tip.impact}
                        </span>
                      </div>
                    </div>
                    <h3 className="text-xl font-bold mb-2 group-hover:text-blue-500 transition-colors">{tip.title}</h3>
